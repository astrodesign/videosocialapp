  ...
  return (
    <Stack.Navigator>
      ...
      <Stack.Group screenOptions={{ presentation: 'modal' }}>
        ...
        <Stack.Screen name="ManageBalance" component={ManageBalance} options={{headerShown: false}}/>
        <Stack.Screen name="Contributor" component={Contributor} options={{headerShown: false}} />
...
>
      ...
      <BottomTab.Screen
        ...
        options={({ navigation }: RootTabScreenProps<'TabOne'>) => ({
          title: 'Featured',
          tabBarIcon: ({ color }) => <Feather name="hexagon" color={color} size={30} />,
          headerRight: () => (
            <Pressable
              onPress={() => navigation.navigate('Modal')}
              style={({ pressed }) => ({
      ...
      <BottomTab.Screen
        ...
        options={{
          headerShown: false, 
          title: 'Profile',
          tabBarIcon: ({ color }) => <Feather name="user" color={color} size={30} />,
        }}
      />
    </BottomTab.Navigator>
  );
